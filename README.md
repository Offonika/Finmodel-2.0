...
Для удобства можно запустить интерактивное меню, предлагающее основные действия:

```bash
finmodel menu
```

Меню позволяет выбирать загрузку заказов, продаж, каталога товаров, а также создавать новую базу из файла схемы и выгружать текущую схему базы данных.
